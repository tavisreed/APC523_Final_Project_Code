...
#     'NAD_bar': 0.84020656,
#     'OAA_bar': 0.00521247,
#     'AcCoA_bar': 0.13593619,
#     'Cit_bar': 0.63921051,
#     'KG_bar': 0.22022558,
#     'ATP_bar': 2.44835469,
#     'psi_bar': 147.75679297,
# }
...
concentration_dict ={
    ...
    'NAD_bar': 0.81068785,
    'OAA_bar': 0.00483366,
    'AcCoA_bar': 0.04916704,
    'Cit_bar': 0.30217164,
    'KG_bar': 0.27841991,
    'ATP_bar': 2.5520087,
    'psi_bar': 152.01254979,
}
...
# Modify rate constants based off predictions from the machine learning model results at 72 HPI
rate_dict['k2'] = rate_dict['k2'] + rate_dict['k2']*-0.15035968491378207*inv_factor # PD Complex
rate_dict['k3'] = rate_dict['k3'] + rate_dict['k3']*0.5797724317493973*inv_factor # Citrate Synthase
rate_dict['k4'] = rate_dict['k4'] + rate_dict['k4']*((-0.131236765039608+0.8446167020278074)/2)*inv_factor # ID complex + Aconitase
rate_dict['k5'] = rate_dict['k5'] + rate_dict['k5']*-0.008343654809182754*inv_factor # AK Complex
rate_dict['k6'] = rate_dict['k6'] + rate_dict['k6']*((0.44709653129778404+1.7236262088196626+0.8871820597913885+0.5308681808527338)/4)*inv_factor # Succinyl-CoA synthetase, Succinic dehydrogenase, Fumarase, Malate dehydrogenase
...
tca.save('./Classes/APC523/Run_72_40_V2_steady')